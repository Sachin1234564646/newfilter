...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002499117193 -1002473524927').split()]  # For Multiple Id Use One Space Between Each.
